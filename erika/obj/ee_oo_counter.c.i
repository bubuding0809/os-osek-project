# 1 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
# 1 "/home/user/git/os-osek-project/erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
# 54 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
...
# 55 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c" 2
...
)
{
  ...
  OsEE_TriggerDB *
    p_previous = 
# 79 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c" 3 4
                   ((void *)0)
# 79 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
                       ;
  OsEE_TriggerDB *
  ...
  while (p_current != 
# 89 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c" 3 4
                     ((void *)0)
# 89 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
                         ) {
  ...
  if (p_previous != 
# 116 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c" 3 4
                   ((void *)0)
# 116 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
                       ) {
...
# 147 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c" 3 4
                          ((void *)0)
# 147 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
                              ) && (p_current != p_trigger_db));

    if (p_current != 
# 149 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c" 3 4
                    ((void *)0)
# 149 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
                        ) {
...
)
{
  OsEE_CounterCB * const
    p_counter_cb = p_counter_db->p_counter_cb;
# 310 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
  {
    ...
    CoreIdType const counter_core_id = osEE_get_curr_core_id();
...
# 333 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
    osEE_lock_core_id(counter_core_id);

    p_triggered_db = p_counter_cb->trigger_queue;

    if (p_triggered_db != 
# 337 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c" 3 4
                         ((void *)0)
# 337 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
                             ) {
      OsEE_TriggerCB *
...
# 352 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c" 3 4
                              ((void *)0)
# 352 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
                                  ) &&
          (p_current->p_trigger_cb->when == counter_value));


        p_previous->p_trigger_cb->p_next = 
# 356 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c" 3 4
                                          ((void *)0)
# 356 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
                                              ;
        ...
        do {
          ...
          if (p_triggered_db != 
# 375 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c" 3 4
                               ((void *)0)
# 375 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
                                   ) {
            p_triggered_cb = p_triggered_db->p_trigger_cb;
          }
...
# 397 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c" 3 4
                                  ((void *)0)
# 397 "/home/user/git/os-osek-project/erika/src/ee_oo_counter.c"
                                      );
      }
    }
