# 1 "/home/user/git/os-osek-project/erika/src/ee_std_change_context.c"
# 1 "/home/user/git/os-osek-project/erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/user/git/os-osek-project/erika/src/ee_std_change_context.c"
# 53 "/home/user/git/os-osek-project/erika/src/ee_std_change_context.c"
...
# 54 "/home/user/git/os-osek-project/erika/src/ee_std_change_context.c" 2
...
{
  OsEE_TCB * const p_to_tcb = p_to->p_tcb;
  TaskStateType const status_prev_running = p_to_tcb->status;
...
)
{
  ...
  OsEE_CTX * const p_bos = p_sdb->p_bos;
...
# 115 "/home/user/git/os-osek-project/erika/src/ee_std_change_context.c" 3 4
                    ((void *)0)
# 115 "/home/user/git/os-osek-project/erika/src/ee_std_change_context.c"
                        ) && (p_tos != p_bos));
