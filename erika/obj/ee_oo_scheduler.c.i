# 1 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
# 1 "/home/user/git/os-osek-project/erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
# 54 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
...
# 55 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c" 2
...
# 209 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
OsEE_bool
  osEE_scheduler_rq_insert
(
  OsEE_RQ * p_rq,
...
)
{
  ...
  OsEE_SN * p_ret_sn = p_ccb->p_stk_sn;

  OsEE_bool is_rq_preemption = OSEE_FALSE;
  OsEE_TDB * p_ret_tdb;

  if (p_ret_sn != 
# 240 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c" 3 4
                 ((void *)0)
# 240 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
                     ) {
    p_ret_tdb = p_ret_sn->p_tdb;
    if (p_rq_sn != 
# 242 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c" 3 4
                  ((void *)0)
# 242 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
                      ) {
      OsEE_TCB * const
...
# 256 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c" 3 4
                       ((void *)0)
# 256 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
                           ) {
  ...
  if (is_rq_preemption) {
    ...
    p_ret_tdb = 
# 275 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c" 3 4
               ((void *)0)
# 275 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
                   ;
    p_ret_sn = 
# 276 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c" 3 4
               ((void *)0)
# 276 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
                   ;
  }
...
)
{
  ...
  OsEE_TCB * const p_tcb_new = p_tdb_new->p_tcb;
  TaskPrio const new_task_prio =
    ((hnd_act) && osEE_is_active_task(p_tcb_new))?
      p_tdb_new->ready_prio:
      p_tcb_new->current_prio;
  OsEE_SN * p_prev = 
# 301 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c" 3 4
                                                           ((void *)0)
# 301 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
                                                               ;
  ...
  while (p_curr != 
# 306 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c" 3 4
                  ((void *)0)
# 306 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
                      ) {
    TaskPrio prio_to_check;
    OsEE_TDB * const p_cur_tdb = p_curr->p_tdb;
    OsEE_TCB * const p_cur_tcb = p_cur_tdb->p_tcb;
  ...
  if (p_prev != 
# 326 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c" 3 4
               ((void *)0)
# 326 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
                   ) {
...
# 361 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
  {
    ...
    if (p_preempt == 
# 369 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c" 3 4
                    ((void *)0)
# 369 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
                        ) {
      OsEE_TDB * p_tdb_stk;
# 380 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
      if ( p_curr_stk_sn != 
# 380 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c" 3 4
                           ((void *)0) 
# 380 "/home/user/git/os-osek-project/erika/src/ee_oo_scheduler.c"
                                ) {
