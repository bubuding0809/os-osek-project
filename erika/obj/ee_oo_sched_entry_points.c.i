# 1 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_entry_points.c"
# 1 "/home/user/git/os-osek-project/erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_entry_points.c"
# 54 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_entry_points.c"
...
# 55 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_entry_points.c" 2
...
# 114 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_entry_points.c"
...
# 149 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_entry_points.c"
  return;
}
...
{
  TaskPrio const task_prio = p_tdb_to->p_tcb->current_prio;
  osEE_scheduler_task_wrapper_restore(p_tdb_to);

  if (task_prio < ((TaskPrio)-1)) {
...
)
{
  ...
  while (p_cdb->p_ccb->os_status == OSEE_KERNEL_STARTED) {
    ...
    if (p_idle_hook != 
# 189 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_entry_points.c" 3 4
                      ((void *)0)
# 189 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_entry_points.c"
                          ) {
      p_idle_hook();
    }
