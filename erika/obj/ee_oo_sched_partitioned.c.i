# 1 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_partitioned.c"
# 1 "/home/user/git/os-osek-project/erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_partitioned.c"
# 54 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_partitioned.c"
...
# 55 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_partitioned.c" 2
...
# 121 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_partitioned.c"
...
{
  OsEE_CCB * const p_ccb = p_cdb->p_ccb;
  OsEE_TDB * const p_tdb_blocked = p_ccb->p_curr;
...
)
{
  ...
  osEE_unlock_core(p_cdb);
# 232 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_partitioned.c"
  ...
  osEE_lock_core(p_cdb);
  {
    ...
    if (p_tcb_term->status == OSEE_TASK_RUNNING) {
...

      {
        ...
        if (p_prev == 
# 308 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_partitioned.c" 3 4
                     ((void *)0)
# 308 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_partitioned.c"
                         ) {
...
)
{
  ...
  if (p_prev != 
# 344 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_partitioned.c" 3 4
               ((void *)0)
# 344 "/home/user/git/os-osek-project/erika/src/ee_oo_sched_partitioned.c"
                   ) {
    OsEE_TDB * const p_curr = p_ccb->p_curr;
