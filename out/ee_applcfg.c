  ...
  tdb_array[OSEE_TASK_ARRAY_SIZE + OSEE_USED_CORES] =
{
    ...
    /* .max_num_of_act = */ 2U},
  {
    ...
    /* .tid            = */ 3U,
    /* .task_type      = */ OSEE_TASK_TYPE_BASIC,
    /* .task_func      = */ TASK_FUNC(ToggleEastServoTask),
    /* .ready_prio     = */ 2U,
    /* .dispatch_prio  = */ 2U,
    /* .max_num_of_act = */ 1U},
  {
    ...
    /* .tid            = */ 4U,
    /* .task_type      = */ OSEE_TASK_TYPE_BASIC,
    /* .task_func      = */ TASK_FUNC(ToggleWestServoTask),
    /* .ready_prio     = */ 2U,
    /* .dispatch_prio  = */ 2U,
    /* .max_num_of_act = */ 1U},
  {
    ...
    /* .max_num_of_act = */ 1U},
  {
    ...
    /* .task_func      = */ TASK_FUNC(ToggleServoTask),
    /* .ready_prio     = */ 2U,
    /* .dispatch_prio  = */ 2U,
    /* .max_num_of_act = */ 1U},
  {
...
VAR(OsEE_AlarmDB, OS_CONST)
  ...
  {
    /* .p_trigger_cb = */ &alarm_cb_array[1U],
    /* .p_counter_db = */ &counter_db_array[0U],
    /* .action       = */ {
      /* .param      = */   {
        /* .f            = */ NULL,
  ...
  {
    /* .p_trigger_cb = */ &alarm_cb_array[2U],
    /* .p_counter_db = */ &counter_db_array[0U],
    /* .action       = */ {
      /* .param      = */   {
        /* .f            = */ NULL,
...
VAR(OsEE_CCB, OS_VAR_INIT) CCB = {
  ...
  /* .api_param1  = */  {INVALID_OBJECT_ID},
  /* .api_param2  = */  {INVALID_OBJECT_ID},
  /* .api_param3  = */  {INVALID_OBJECT_ID},
