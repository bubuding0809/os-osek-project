...
# 1 "ee_applcfg.c"
# 20 "ee_applcfg.c"
# 1 "/home/user/git/os-osek-project/erika/inc/ee_conf.h" 1
# 62 "/home/user/git/os-osek-project/erika/inc/ee_conf.h"
# 1 "/home/user/git/os-osek-project/erika/inc/ee.h" 1
# 61 "/home/user/git/os-osek-project/erika/inc/ee.h"
# 1 "/home/user/git/os-osek-project/erika/inc/ee_cfg.h" 1
# 55 "/home/user/git/os-osek-project/erika/inc/ee_cfg.h"
# 1 "/home/user/git/os-osek-project/out/ee_applcfg.h" 1
# 28 "/home/user/git/os-osek-project/out/ee_applcfg.h"
# 1 "/home/user/git/os-osek-project/erika/inc/ee_oscfg.h" 1
# 29 "/home/user/git/os-osek-project/out/ee_applcfg.h" 2
# 56 "/home/user/git/os-osek-project/erika/inc/ee_cfg.h" 2
# 62 "/home/user/git/os-osek-project/erika/inc/ee.h" 2
...
typedef int wchar_t;
# 426 "/home/user/arduino-1.8.15/hardware/tools/avr/lib/gcc/avr/7.3.0/include/stddef.h" 3 4
typedef struct {
...
# 38 "/home/user/arduino-1.8.15/hardware/tools/avr/avr/include/avr/interrupt.h" 3
...
# 63 "/home/user/git/os-osek-project/erika/inc/ee.h" 2
# 1 "/home/user/git/os-osek-project/erika/inc/ee_compiler.h" 1
# 64 "/home/user/git/os-osek-project/erika/inc/ee.h" 2
# 1 "/home/user/git/os-osek-project/erika/inc/ee_utils.h" 1
# 65 "/home/user/git/os-osek-project/erika/inc/ee.h" 2
...
# 66 "/home/user/git/os-osek-project/erika/inc/ee.h" 2
...
typedef struct OsEE_CCB_tag {
  ...
  OsEE_api_param api_param1;
  OsEE_api_param api_param2;
  OsEE_api_param api_param3;
...
# 67 "/home/user/git/os-osek-project/erika/inc/ee.h" 2
...
# 71 "/home/user/git/os-osek-project/erika/inc/ee.h" 2
# 63 "/home/user/git/os-osek-project/erika/inc/ee_conf.h" 2
# 1 "/home/user/git/os-osek-project/erika/inc/ee_hal_internal_types.h" 1
# 64 "/home/user/git/os-osek-project/erika/inc/ee_conf.h" 2
# 1 "/home/user/git/os-osek-project/erika/inc/ee_scheduler_types.h" 1
# 65 "/home/user/git/os-osek-project/erika/inc/ee_conf.h" 2
# 1 "/home/user/git/os-osek-project/erika/inc/ee_kernel_types.h" 1
# 66 "/home/user/git/os-osek-project/erika/inc/ee_conf.h" 2
...
# 67 "/home/user/git/os-osek-project/erika/inc/ee_conf.h" 2
# 21 "ee_applcfg.c" 2
...
extern void FuncDetectTask ( void );
extern void FuncDisplayTask ( void );
extern void FuncToggleEastServoTask ( void );
extern void FuncToggleWestServoTask ( void );
extern void FuncClockTask ( void );
extern void FuncToggleServoTask ( void );
# 48 "ee_applcfg.c"
extern void idle_hook (void);
# 63 "ee_applcfg.c"
OsEE_stack __attribute__((aligned((sizeof(OsEE_stack)))))
...
OsEE_SCB scb_array[(2U)] =
{
  { ((OsEE_addr)&osEE_task_stack_1[((sizeof(osEE_task_stack_1)/sizeof(osEE_task_stack_1[0])) - 1U) & (~(((sizeof(OsEE_stack))/sizeof(OsEE_stack)) -1U))]) },
  { 
# 75 "ee_applcfg.c" 3 4
                   ((void *)0) 
# 75 "ee_applcfg.c"
...
OsEE_SDB sdb_array[(2U)] =
{
  {
                        ((OsEE_addr)&osEE_task_stack_1[0U]),
                        (128U)
  },
  {
...
OsEE_MCB res_cb_array[(1U)];

OsEE_MDB res_db_array[(1U)] = {
  {
                      &res_cb_array[0U],
                      3U
  }
...
OsEE_TDB * const
  tdb_ptr_autostart_OSDEFAULTAPPMODE[4U] =
{
  &tdb_array[1U],
  &tdb_array[2U],
  &tdb_array[5U],
...
OsEE_autostart_tdb osEE_autostart_tdb[1U] =
{
  {
                              &tdb_ptr_autostart_OSDEFAULTAPPMODE,
                              ((sizeof(tdb_ptr_autostart_OSDEFAULTAPPMODE)/sizeof(0[tdb_ptr_autostart_OSDEFAULTAPPMODE])) / (!(sizeof(tdb_ptr_autostart_OSDEFAULTAPPMODE) % sizeof(0[tdb_ptr_autostart_OSDEFAULTAPPMODE]))))
  }
};
...
# 407 "ee_applcfg.c" 3 4
                             ((void *)0)
# 407 "ee_applcfg.c"
                                 ,
                              &tdb_array[1U],
                              
# 409 "ee_applcfg.c" 3 4
                             ((void *)0)
# 409 "ee_applcfg.c"
                                 ,
                              0U},
...
# 419 "ee_applcfg.c" 3 4
                             ((void *)0)
# 419 "ee_applcfg.c"
                                 ,
                              &tdb_array[2U],
                              
# 421 "ee_applcfg.c" 3 4
                             ((void *)0)
# 421 "ee_applcfg.c"
                                 ,
                              0U},
...
# 431 "ee_applcfg.c" 3 4
                             ((void *)0)
# 431 "ee_applcfg.c"
                                 ,
                              &tdb_array[5U],
                              
# 433 "ee_applcfg.c" 3 4
                             ((void *)0)
# 433 "ee_applcfg.c"
                                 ,
                              0U},
...
OsEE_autostart_trigger_info
  trigger_autostart_info_OSDEFAULTAPPMODE[3U] =
{
  {
                          &alarm_db_array[0U],
                          (1U),
...
OsEE_autostart_trigger osEE_autostart_trigger_db[1U] =
{
  {
                              &trigger_autostart_info_OSDEFAULTAPPMODE,
                              ((sizeof(trigger_autostart_info_OSDEFAULTAPPMODE)/sizeof(0[trigger_autostart_info_OSDEFAULTAPPMODE])) / (!(sizeof(trigger_autostart_info_OSDEFAULTAPPMODE) % sizeof(0[trigger_autostart_info_OSDEFAULTAPPMODE]))))
  }
};
...
OsEE_CDB CDB = {
                                         ...
                                         &counter_db_array[0U],
                                         &osEE_autostart_tdb,
                                         ((sizeof(osEE_autostart_tdb)/sizeof(0[osEE_autostart_tdb])) / (!(sizeof(osEE_autostart_tdb) % sizeof(0[osEE_autostart_tdb])))),
                                         &osEE_autostart_trigger_db,
                                         ((sizeof(osEE_autostart_trigger_db)/sizeof(0[osEE_autostart_trigger_db])) / (!(sizeof(osEE_autostart_trigger_db) % sizeof(0[osEE_autostart_trigger_db]))))
};
...
OsEE_KDB KDB = {
                              ...
                              &tdb_ptr_array,
                              &sn_array,
                              ((sizeof(tdb_ptr_array)/sizeof(0[tdb_ptr_array])) / (!(sizeof(tdb_ptr_array) % sizeof(0[tdb_ptr_array])))),
                              ((sizeof(sn_array)/sizeof(0[sn_array])) / (!(sizeof(sn_array) % sizeof(0[sn_array])))),
                              &res_db_ptr_array,
                              ((sizeof(res_db_array)/sizeof(0[res_db_array])) / (!(sizeof(res_db_array) % sizeof(0[res_db_array])))),
                              &counter_db_ptr_array,
                              ((sizeof(counter_db_array)/sizeof(0[counter_db_array])) / (!(sizeof(counter_db_array) % sizeof(0[counter_db_array])))),
                              &alarm_db_ptr_array,
                              ((sizeof(alarm_db_array)/sizeof(0[alarm_db_array])) / (!(sizeof(alarm_db_array) % sizeof(0[alarm_db_array]))))};
